...
alert('mafe soupe kandia domoda, tiep bou honk tiep bou weikh bou am soule'); // alert('css ', css)

var a = (0,_calculator__WEBPACK_IMPORTED_MODULE_1__.default)(3, 2, 'subs');
alert(a); // sayHello('Elhadji')
})();
